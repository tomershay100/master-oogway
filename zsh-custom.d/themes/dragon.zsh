...
__set_git_status_prefix_and_suffix()
{
	...
	if [[ $VCS_STATUS_HAS_UNSTAGED -eq 1 || $VCS_STATUS_HAS_STAGED -eq 1 ]]; then
		REAL_DRAGON__GIT_STATUS_SUFFIX="$DRAGON__GIT_BRANCH_SUFFIX$GIT_REMOTE_STATE_STR$GIT_STASH_STR$DRAGON__GIT_DIRTY_SUFFIX$DRAGON__GIT_STATUS_SUFFIX"
	else
		REAL_DRAGON__GIT_STATUS_SUFFIX="$DRAGON__GIT_BRANCH_SUFFIX$GIT_REMOTE_STATE_STR$GIT_STASH_STR$DRAGON__GIT_CLEAN_SUFFIX$DRAGON__GIT_STATUS_SUFFIX"
	fi
}
