...
export DRAGON__USERNAME_VIA_SSH_FOREGROUND_COLOR='223' # cream
export DRAGON__ENABLE_HOSTNAME='true'
export DRAGON__HOSTNAME_FOREGROUND_COLOR='183'        # lavender
export DRAGON__ENABLE_HOSTNAME_COLORING_VIA_SSH='true'
export DRAGON__HOSTNAME_VIA_SSH_FOREGROUND_COLOR='217'
export DRAGON__ENABLE_DIRECTORY='true'
export DRAGON__DIRECTORY_FORMAT='regular'
export DRAGON__DIRECTORY_FOREGROUND_COLOR='151'       # mint
export DRAGON__USER_HOST_SEPARATOR=' · '
export DRAGON__HOST_DIR_SEPARATOR=' · '
export DRAGON__PROMPT_SEPARATOR_FOREGROUND_COLOR='250'
...
export DRAGON__PROMPT_CHAR_FAILURE_FOREGROUND_COLOR='217'
...
export DRAGON__SSH_PREFIX_FOREGROUND_COLOR='183'
...
export DRAGON__GIT_CLEAN_FOREGROUND_COLOR='151'
export DRAGON__GIT_CLEAN_SUFFIX=' ✓'
export DRAGON__GIT_DIRTY_FOREGROUND_COLOR='217'
