...
_dragon_init_groups() {
	...
	typeset -gA _DRAGON_GROUP_VARS=(
		...
		[git_status]="ENABLE_GIT_STATUS GIT_STATUS_ON_NEW_LINE GIT_STATUS_PREFIX GIT_STATUS_SUFFIX GIT_BRANCH_PREFIX GIT_BRANCH_SUFFIX GIT_ACTION_COLOR"
