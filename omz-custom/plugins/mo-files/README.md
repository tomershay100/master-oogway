...
`extract` scans zip archives for path traversal before extracting — `.zip` files go into a named subdirectory. `compress` refuses to overwrite an existing archive.
